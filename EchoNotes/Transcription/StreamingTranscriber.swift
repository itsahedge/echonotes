...
final class StreamingTranscriber {
    ...
    @ObservationIgnored private nonisolated let sampleLock = NSLock()
    @ObservationIgnored private nonisolated(unsafe) var incomingSamples: [Float] = []

    @ObservationIgnored private nonisolated let srcFormat = AVAudioFormat(commonFormat: .pcmFormatFloat32, sampleRate: 48000, channels: 1, interleaved: false)!
    @ObservationIgnored private nonisolated let dstFormat = AVAudioFormat(commonFormat: .pcmFormatFloat32, sampleRate: 16000, channels: 1, interleaved: false)!
